...
serve(async (req) => {
  ...
  try {
    ...
    const { data, error } = await supabase.rpc('update_marketplace_stats')
    ...
    console.log('Marketplace stats updated successfully:', data)
    ...
    console.error('Error in update-marketplace-stats function:', error)
