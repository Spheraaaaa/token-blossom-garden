...
export const WalletBalance = ({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
      <div className="rounded-2xl border border-border/50 bg-card/90 overflow-hidden relative shadow-xl">
        ...
        <div className="flex flex-col space-y-2 p-4 relative">
          <div className="p-4 rounded-lg bg-card border border-border/40 flex items-center justify-between transition-colors duration-200">
            <div className="flex items-center gap-3">
        ...
        <div className="rounded-2xl border border-border/50 bg-card/90 overflow-hidden relative shadow-xl">
          ...
          <div className="flex flex-col space-y-2 p-4">
            ...
            {showFrozenDetails && frozenBalanceDetails.length > 0 && (
              <div className="mt-4 pt-4 space-y-3 border-t border-border/40">
